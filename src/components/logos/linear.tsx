    ...
    return (
      ...
      >
        ...
        <defs>
          ...
          <filter id="b" width="295.583" height="295.582" x="126.135" y="66.88" colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse">
          ...
          <filter id="c" width="267.583" height="267.582" x="140.135" y="86" colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse">
            <feFlood floodOpacity="0" result="BackgroundImageFix" />
            <feBlend in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
            <feGaussianBlur result="effect1_foregroundBlur_14134_4654" stdDeviation="5" />
          </filter>
          <filter id="e" width="171.522" height="177.592" x="102.218" y="160.522" colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse">
            <feFlood floodOpacity="0" result="BackgroundImageFix" />
            <feBlend in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
            <feGaussianBlur result="effect1_foregroundBlur_14134_4654" stdDeviation="5" />
          </filter>
