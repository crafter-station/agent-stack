	...
	return new ImageResponse(
		...
		>
			...
			>
				...
				>
					<span style={{ color: "#fafafa", fontWeight: 700, display: "flex" }}>
						49
					</span>
					<span style={{ color: "#525252", display: "flex" }}>services</span>
					<span style={{ color: "#262626", display: "flex" }}>|</span>
					<span style={{ color: "#fafafa", fontWeight: 700, display: "flex" }}>
						5
					</span>
					<span style={{ color: "#525252", display: "flex" }}>dimensions</span>
					<span style={{ color: "#262626", display: "flex" }}>|</span>
					<span style={{ color: "#fafafa", fontWeight: 700, display: "flex" }}>
						100
					</span>
					<span style={{ color: "#525252", display: "flex" }}>max score</span>
				</div>
			</div>
		</div>,
		{ ...size },
